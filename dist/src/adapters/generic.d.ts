import { type PromptTransformResult, type TransformOptions } from "../transform.js";
 ...
 */
export declare function invokeWithCompression<T>(originalPrompt: string, send: (modelPrompt: string, transform: PromptTransformResult) => T | Promise<T>, options?: TransformOptions): Promise<GenericHarnessInvocation<T>>;
